  ...
  const translations = {
    en: {
      trainer: {
        ...
        subtitle: "Manage your courses, monitor progress, and guide learners.",
        ...
        manageAndMonitor: "Manage and monitor your training courses.",
        ...
        structuredLearning: "Structured learning journeys for your team.",
        createLearningPath: "Create Learning Path",
        learningPathsNotAvailable: "No learning paths available.",
        recentLearningActivity: "Recent Learning Activity",
        latestEmployeeProgress: "Latest employee progress and completions.",
        modules: "Modules",
        published: "Published",
        draft: "Draft",
        status: {
    ...
    fr: {
      trainer: {
        ...
        subtitle:
          "Gérez vos cours, suivez les progrès et guidez les apprenants.",
        ...
        manageAndMonitor: "Gérez et surveillez vos cours de formation.",
        ...
        structuredLearning:
          "Parcours d'apprentissage structurés pour votre équipe.",
        createLearningPath: "Créer un parcours",
        learningPathsNotAvailable: "Aucun parcours disponible.",
        recentLearningActivity: "Activité d'apprentissage récente",
        latestEmployeeProgress: "Derniers progrès et validations des employés.",
        modules: "Modules",
        published: "Publié",
        draft: "Brouillon",
        status: {
      ...
      errors: {
        ...
        loadCoursesFailed: "Échec du chargement des cours.",
      },
    },
  };
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {loading ? "..." : trainingStats.totalCourses}
              </div>
              <p className="text-xs text-muted-foreground">
                {t("trainer.availableCourses")}
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">
                {t("trainer.activeEnrollments")}
              </CardTitle>
              <Users className="h-4 w-4 text-blue-600" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-blue-600">
                {trainingStats.activeEnrollments}
              </div>
              <p className="text-xs text-muted-foreground">
                {t("trainer.currentlyLearning")}
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">
                {t("trainer.averageScore")}
              </CardTitle>
              <TrendingUp className="h-4 w-4 text-purple-600" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-purple-600">
                {trainingStats.averageScore}%
              </div>
              <p className="text-xs text-muted-foreground">
                {t("trainer.coursePerformance")}
              </p>
            </CardContent>
          </Card>
        </div>
                  ...
                  <div key={course.id} className="p-4 border rounded-lg">
                    <div className="flex justify-between items-start mb-3">
                      <div className="space-y-1">
                        ...
                        <p className="text-xs text-muted-foreground">
                          {t("trainer.duration")}: {course.duration}
                        </p>
                      </div>

                      <div className="text-right space-y-2">
                        <Badge className={getStatusColor(course.status)}>
                          {t(`trainer.status.${course.status.toLowerCase()}`)}
                        </Badge>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        <span>
                          {t("trainer.progress")}: {course.completed}/
                          {course.enrolled} {t("trainer.completed")}
                        </span>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid gap-4">
              <div className="text-center py-8">
                {t("trainer.learningPathsNotAvailable")}
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {t("trainer.latestEmployeeProgress")}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
        ...
        <Modal open={!!previewCourse} onClose={() => setPreviewCourse(null)}>
          <div className="p-6 space-y-4">
            ...
            <div className="flex flex-wrap gap-2 mb-2">
              ...
              <Badge
                variant={
                  previewCourse.status === "published" ? "default" : "secondary"
                }
              >
